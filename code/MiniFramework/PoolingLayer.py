...
class PoolingLayer(CLayer):
    ...
    def backward_col2img(self, delta_in, layer_idx):
        ...
        dx = col2img(dcol, self.x.shape, self.pool_height, self.pool_width, self.stride, 0, self.output_height,
                     self.output_width)
        return dx
    ...
    def forward_numba(self, x, train=True):
        ...
        self.z = jit_maxpool_forward(self.x, self.batch_size, self.num_input_channel, self.output_height,
    ...
    def backward_numba(self, delta_in, layer_idx):
        ...
        delta_out = jit_maxpool_backward(self.x, delta_in, self.batch_size, self.num_input_channel, self.output_height,
                                         self.output_width, self.pool_height, self.pool_width, self.stride)
        return delta_out
